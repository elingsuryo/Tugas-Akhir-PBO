...
class OnlineTest extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==b1)
		{
			...
			if(kode1.isEnabled()){
				kode1.setEnabled(true);
				kode2.setEnabled(false);
				kode3.setEnabled(false);
				kode4.setEnabled(false);
				pweb();
			}
			if(kode2.isEnabled()){
				kode1.setEnabled(false);
				kode2.setEnabled(true);
				kode3.setEnabled(false);
				kode4.setEnabled(false);
				ddp();
			}
	...
	void basdat(){
		...
		if(current==1)
		{
			...
			jb[0].setText("Menghasilkan laporan");jb[1].setText("Mengelola dan menyediakan akses ke data");jb[2].setText("Menyusun kode program");
		}
		if(current==2)
		{
			l.setText("3. Apa yang dimaksud dengan Primary Key dalam basis data?");
			jb[0].setText("Kunci utama yang unik untuk setiap baris data");jb[1].setText("Kunci yang dapat digunakan untuk membuka database");jb[2].setText("Nama tabel utama dalam database");
		}
		if(current==3)
		{
			l.setText("4. Apa perbedaan antara basis data relasional dan basis data non-relasional?");
			jb[0].setText("Basis data relasional menggunakan tabel, sedangkan non-relasional tidak");jb[1].setText("Basis data relasional hanya dapat menyimpan data teks");jb[2].setText("Keduanya sama");
		}
		if(current==4)
		{
			l.setText("5. Apa yang dimaksud dengan normalisasi dalam konteks basis data?");
			jb[0].setText("Proses mengurangi tingkat keamanan data");jb[1].setText("Proses mengorganisir data untuk menghindari duplikasi");jb[2].setText("Proses mengenkripsi seluruh basis data");
		}
		if(current==5)
		{
			l.setText("6. Apa kegunaan indeks dalam basis data?");
			jb[0].setText("Membuat salinan data");jb[1].setText("Mempercepat proses pencarian dan pengurutan data");jb[2].setText("Menghapus data dari tabel");
		}
		if(current==6)
		{
			l.setText("7. Apa yang dimaksud dengan SQL (Structured Query Language)?");
			jb[0].setText("Bahasa pemrograman tingkat tinggi");jb[1].setText("Bahasa kueri untuk berinteraksi dengan basis data");jb[2].setText("Bahasa pemrograman rendah");
		}
		if(current==7)
		{
			l.setText("8. Apa perbedaan antara data bersifat unik dan data bersifat berulang dalam basis data?");
			jb[0].setText("Data bersifat unik hanya dapat muncul sekali, sedangkan data bersifat berulang dapat muncul beberapa kali");jb[1].setText("Keduanya memiliki arti yang sama");jb[2].setText("Data bersifat unik hanya dapat digunakan pada jenis data teks");
		}
		if(current==8)
		{
			l.setText("9. Apa yang dimaksud dengan transaksi dalam basis data?");
			jb[0].setText("Proses mematikan basis data");jb[1].setText("Kumpulan perintah SQL");jb[2].setText("Sekumpulan operasi yang dianggap sebagai satu unit logis");
		}
		if(current==9)
		{
			l.setText("10. Apa itu konsep \"foreign key\" dalam basis data relasional?");
			jb[0].setText("Kunci utama yang unik untuk setiap baris data");jb[1].setText("Kunci yang menghubungkan dua tabel");jb[2].setText("Nama kunci dalam basis data");
		}
